...
description: |
  Security pattern library defining CRITICAL/HIGH/MEDIUM severity levels.
  CRITICAL and HIGH patterns trigger immediate Rollback.
  Includes safe implementation patterns.
allowed-tools: Read
---
